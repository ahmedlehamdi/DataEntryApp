<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditFlyerDetails.aspx.cs" Inherits="DataEntryApp.Pages.EditFlyerDetails" %>
                                ...
                                <div class="form-body">
                                    <form id="flyerDataForm" method="post" enctype="multipart/form-data" runat="server">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" id="flyerImageFile" name="flyerImageFile" multiple />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="providerDD" id="providerDD" class="form-control1" data-validation="selected" required="" ViewStateMode="Enabled">
