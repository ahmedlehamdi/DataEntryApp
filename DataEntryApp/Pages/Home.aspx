...
<head>
    ...
    <!-- //chart -->
    <!-- js-->
    <script src="../DataTables/jQuery-1.12.3/jquery-1.12.3.min.js"></script>
        ...
        <div id="page-wrapper">
            <div class="main-page">
                ...
                <div class="row four-grids">
                    ...
                    <div class="col-md-4 ticket-grid" onclick="showUserEditPasswordModal()">
                        <div class="tickets">
                            <div class="grid-left">
                                <div class="book-icon">
                ...
                <div class="grids">
                    <div class="panel panel-widget">
                        <div class="tables">
                            ...
                            <table class="table table-striped table-bordered bootstrap-datatable datatable" id="flyersTable">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Flyer Name</th>
