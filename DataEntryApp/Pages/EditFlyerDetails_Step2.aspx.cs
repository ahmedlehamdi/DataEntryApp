...
{
    public partial class EditFlyerDetails_Step2 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                if (this.Request.QueryString["fnID"] != null && this.Request.QueryString["fnID"] == "13")
                {
                    retrieveFlyerProducts();
                }
            }
        }

        private void retrieveFlyerProducts()
        {
